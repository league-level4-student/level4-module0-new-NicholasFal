...
//		}
	...
	private void gameOver() {
		...
		JOptionPane.showMessageDialog(null, "Your snake died. Game over!");
		 ...
		 * exit the game.
		 */
		if(playAgain.equalsIgnoreCase("yes") || playAgain.equalsIgnoreCase("sure") || playAgain.equalsIgnoreCase("yeah")) {
			snake.resetLocation();
			randomizeFoodLocation();
			timer.restart();
		} else {
